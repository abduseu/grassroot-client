    ...
    return (
        <div className="bg-[#2F2D2D] lg:bg-gradient-to-r from-black to-gray-600 text-white rounded-lg lg:flex lg:justify-between lg:items-center">
            <div className="font-black max-w-2xl leading-snug p-10 text-5xl md:text-7xl md:p-20 md:leading-snug">
                <h2>Delight in<br />
                    <span><ReactTyped strings={["Every Bites", "Fine Dining"]} typeSpeed={100} backSpeed={50} loop /></span> <br/>
                </h2>
                <p className="font-thin text-lg">At Grassroot, savor the finest flavors in every dish. Our passion for fresh ingredients and culinary excellence ensures each bite is a delightful experience.</p>
            </div>
